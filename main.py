...
# Add this after symptoms_dict is defined
...
def home():
    if request.method == 'POST':
        # Handle both dropdown and text input methods
        user_symptoms = request.form.getlist('symptoms')  # From dropdown
        
        # If no symptoms from dropdown, check text input
        ...
        if not user_symptoms:
            ...
            return render_template('index.html', message=message, symptoms_list=symptoms_list, selected_symptoms=[])
        ...
        if invalid_symptoms:
            ...
            return render_template('index.html', message=message, symptoms_list=symptoms_list, selected_symptoms=user_symptoms)
        ...
        return render_template(
            ...
            dis_des=dis_des,
            dis_pre=my_precautions,
            dis_med=medications,
            dis_die=formatted_diet,
            dis_wrkout=workout,
            symptoms_list=symptoms_list,
            selected_symptoms=user_symptoms
        )
    return render_template("index.html", symptoms_list=symptoms_list, selected_symptoms=[])
